...
- [SOC Analyst & Firewalls](#soc-analyst--firewalls)
- [Summary](#summary)
...
- الـ Firewalls ممكن تكون **Perimeter** (لحماية الشبكة من الخارج) أو **Internal** (لفصل الـ Departments من الداخل ومنع الـ Lateral Movement).

- أسلوب الـ **Default Deny** هو الأكثر أماناً — بتسمح بس بالحد الأدنى اللي محتاجه، وباقي كل حاجة محظورة.
