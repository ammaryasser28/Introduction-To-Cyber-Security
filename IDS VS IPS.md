> **الهدف من الـ Section ده:** هتفهم إزاي الـ IDS والـ IPS بيشتغلوا، وإيه الفرق بينهم، وإزاي بيكتشفوا الهجمات — وهتقدر تفرق بين الـ Detection والـ Prevention وتعرف متى تستخدم كل واحد فيهم.
